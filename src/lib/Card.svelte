...
<svelte:head>
  ...
  <title>Happy Birthday Allisoon!</title>
  <meta name="description" content="Happy Birthday Allison!" />
</svelte:head>

<article class={`relative h-screen w-screen bg-gradient-to-b from-lavender-500 to-purple-200 ${isOpen ? 'open' : ''}`}>
  <Confetti />
  <div
